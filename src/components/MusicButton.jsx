...
//             <span className="text-[10px] uppercase tracking-[3px] text-dark/60 font-bold">
//               Reproducir música
//             </span>
    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
        ...
        <div
          onClick={handleClick}
          className={`
            glass cursor-pointer border border-gold/40
            transition-all duration-500 ease-in-out
            flex items-center justify-center
            rounded-full relative
            ${playing
              ? "px-4 py-3 gap-3 w-[160px] shadow-[0_8px_32px_rgba(0,0,0,0.12)]"
              : "w-[52px] h-[52px] shadow-[0_0_18px_4px_rgba(200,169,107,0.35),0_0_6px_2px_rgba(200,169,107,0.25)]"
            }
          `}
        >
